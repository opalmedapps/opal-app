...
app.controller('LoginController',['$rootScope','$state', '$scope','UpdateUI', 'UserAuthorizationInfo','UserPreferences', '$q','Modal', 'Messages','RequestToServer','Patient',function($rootScope, $state, $scope, UpdateUI, UserAuthorizationInfo, UserPreferences, $q, Modal, Messages, RequestToServer,Patient){
