...
Contributions in the form of translations are always welcome.
To add support for a new language in the app, follow the steps below:

1. Find the 2-character ISO 639-1 language code (such as `en`, `fr`, etc.) for the new language to be added
