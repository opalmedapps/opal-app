...
function scrollIntoView(element, spot) {
    // Assuming offsetParent is available (it's not available when pdfviewer is in
...
var ProgressBar = (function ProgressBarClosure() {
    ...
    function ProgressBar(id, opts) {
        ...
        // Get the loading bar element, so it can be resized to fit the pdfviewer.
 ...
 *   or every time the pdfviewer is loaded.
 */
var Preferences = {
    ...
    initialize: function pdfHistoryInitialize(fingerprint, linkService) {
        ...
        if (this._isStateObjectDefined(state)) {
            ...
            if (state && state.fingerprint &&
                ...
                // is opened in the web pdfviewer.
        ...
        window.addEventListener('pageshow', function pdfHistoryPageShow(evt) {
            // If the entire pdfviewer (including the PDF file) is cached in the browser,
...
var DocumentProperties = {
    ...
    // Document property fields (in the pdfviewer).
    fileNameField: null,
    fileSizeField: null,
    titleField: null,
    authorField: null,
...
/**
 * @constructor
 * @param {HTMLDivElement} container - The pdfviewer element.
 ...
 * @property {HTMLDivElement} container - The container for the pdfviewer element.
 * @property {HTMLDivElement} pdfviewer - (optional) The pdfviewer element.
...
/**
 * Simple pdfviewer control to display PDF content/pages.
 * @class
            ...
            if (scale > 0) {
                ...
                switch (value) {
                    ...
                    case 'auto':
                        ...
                        // For pages in landscape mode, fit the page height to the pdfviewer
...
var PDFViewerApplication = {
    ...
    load: function pdfViewLoad(pdfDocument, scale) {
        ...
        firstPagePromise.then(function(pdfPage) {
            ...
            if (!PDFJS.disableHistory && !self.isViewerEmbedded) {
                // The browsing history is only enabled when the pdfviewer is standalone,
        ...
        Promise.all([firstPagePromise, storePromise, showPreviousViewOnLoadPromise,
            ...
            // unless the pdfviewer is embedded in a web page.
    ...
    setInitialView: function pdfViewSetInitialView(storedHash, scale) {
        ...
        // When opening a new file (when one is already loaded in the pdfviewer):
...
/**
 * Simple pdfviewer control to display thumbs for pages.
 * @class
 */
...
function webViewerLoad(evt) {
    ...
    var myElement = document.getElementById('viewerContainer');
    var mc = new Hammer.Manager(myElement);
    var pinch = new Hammer.Pinch();
    mc.add(pinch);
    mc.on('pinch', function(ev) {
        console.log("got pinch", ev);
...
function handleMouseWheel(evt) {
    ...
    } else if (evt.ctrlKey) { // Only zoom the pages, not the entire pdfviewer
        evt.preventDefault();
...
window.addEventListener('keydown', function keydown(evt) {
    ...
    if (!handled && !PresentationMode.active) {
        ...
        if (evt.keyCode >= 33 && evt.keyCode <= 40 &&
            ...
            // pressed. Change the focus to the pdfviewer container to make sure that
