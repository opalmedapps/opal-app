...
.controller('UibDatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$locale', '$log', 'dateFilter', 'uibDatepickerConfig', '$datepickerSuppressError', 'uibDateParser',
  ...
  this.createDateObject = function(date, format) {
    ...
    var dt = {
      ...
      showColor: this.showColor(date) || null,
      showBlue: this.showBlue(date) || null,
      showGreen: this.showGreen(date) || null
    };
  ...
  this.showColor = function(date) {
    return $scope.showColor({date: date});
  };
  this.showBlue = function(date) {
    return $scope.showBlue(date);
  };
  this.showGreen = function(date) {
    return $scope.showGreen(date);
  };
...
function(scope, element, attrs, $compile, $parse, $document, $rootScope, $position, dateFilter, dateParser, datepickerPopupConfig, $timeout, datepickerConfig) {
  ...
  this.init = function(_ngModel_) {
    ...
    if (attrs.showColor) {
      datepickerEl.attr('show-color', 'showColor({date: date})');
    }
    if (attrs.showBlue) {
      datepickerEl.attr('show-blue', 'showBlue(date)');
    }
    if (attrs.showGreen) {
      datepickerEl.attr('show-green', 'showGreen(date)');
    }
...
angular.module("uib/template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/day.html",
    "<table ng-swipe-left=\"move(1)\" ng-swipe-right=\"move(-1)\" class=\"uib-daypicker\" role=\"grid\" aria-labelledby=\"{{::uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
    "  <thead>\n" +
    "    <tr>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left uib-left\" ng-click=\"move(-1)\" tabindex=\"-1\" style='width:14.28vw;'><i style='font-size:15px;' class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
    "      <th colspan=\"{{::5 + showWeeks}}\"><button id=\"{{::uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" aria-atomic=\"true\" type=\"button\" class=\"btn btn-default btn-sm uib-title\" ng-click=\"toggleMode()\" ng-disabled=\"datepickerMode === maxMode\" tabindex=\"-1\"style='width:71.43vw;max-width:78vw;' ><div style='font-weight:500;font-size:15px'><strong>{{title}}</strong></div></button></th>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-right uib-right\" ng-click=\"move(1)\" tabindex=\"-1\" style='width:14.28vw;'><i style='font-size:15px;' class=\"glyphicon glyphicon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
    "    <tr>\n" +
    ...
    "          tabindex=\"-1\"><span ng-class=\"::{'text-muted': dt.secondary, 'text-info': dt.current}\" style=\"font-weight:500;font-size:17px\">{{::dt.label}}<br> </span><div style='margin-top:-10px'><i ng-style =\"{color: dt.showColor }\"  class='icon ion-record calendar-marker'></i></div></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
...
angular.module("uib/template/datepicker/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/month.html",
    "<table ng-swipe-left=\"move(1)\" ng-swipe-right=\"move(-1)\" class=\"uib-monthpicker\" role=\"grid\" aria-labelledby=\"{{::uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
    "  <thead>\n" +
    "    <tr>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left uib-left \" ng-click=\"move(-1)\" tabindex=\"-1\" style=\"text-align:left;padding-left:20px\" \><i  style=\"font-size:15px\" class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
    "      <th><button id=\"{{::uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" aria-atomic=\"true\" type=\"button\" class=\"btn btn-default btn-sm uib-title\" ng-click=\"toggleMode()\" ng-disabled=\"datepickerMode === maxMode\" tabindex=\"-1\" style='font-weight:500;font-size:15px'><strong>{{title}}</strong></button></th>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-right uib-right \" ng-click=\"move(1)\" tabindex=\"-1\" style=\"text-align:right;padding-right:20px\" \><i style=\"font-size:15px\" class=\"glyphicon glyphicon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
...
angular.module("uib/template/datepicker/year.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/year.html",
    "<table ng-swipe-left=\"move(1)\" ng-swipe-right=\"move(-1)\" class=\"uib-yearpicker\" role=\"grid\" aria-labelledby=\"{{::uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
    "  <thead>\n" +
    "    <tr>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-left uib-left\" ng-click=\"move(-1)\" tabindex=\"-1\" style=\"width:16.6vw;margin:0\"><i style=\"font-size:15px\" class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
    "      <th colspan=\"{{::columns - 2}}\" style=\"margin:0\"><button id=\"{{::uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" aria-atomic=\"true\" type=\"button\" class=\"btn btn-default btn-sm uib-title\" ng-click=\"toggleMode()\" ng-disabled=\"datepickerMode === maxMode\" tabindex=\"-1\" style=\"width:66.6vw;margin:0;\"><strong>{{title}}</strong></button></th>\n" +
    "      <th><button type=\"button\" class=\"btn btn-default btn-sm pull-right uib-right\" ng-click=\"move(1)\" tabindex=\"-1\" style=\"width:16.6vw;margin:0\"><i style=\"font-size:15px\"  class=\"glyphicon glyphicon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
