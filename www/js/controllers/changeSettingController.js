...
(function () {
    ...
    ChangeSettingController.$inject = ['Patient', 'UserPreferences', '$scope', '$timeout', 'NavigatorParameters'];

    /* @ngInject */
    function ChangeSettingController($filter, $rootScope, FirebaseService, $translate, UserPreferences,
