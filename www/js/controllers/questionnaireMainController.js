...
app1.controller('QuestionnaireMainController', function($scope, $rootScope, $sce, $http, $window, $filter, progressBarManager, Questionnaires, $timeout) {
  ...
  function initQuestionnaire()
  {
    ...
    $scope.subData = Questionnaires.isQuestionnaireComplete(0);
   
    setQuestionnaireAnswersObject(Questionnaires.getQuestionnaireAnswers(0)); 
    $scope.questionaires = Questionnaires.getPatientQuestionnaires();
    console.log($scope.questionaires);
    $scope.questionaire = $scope.questionaires[0];
...
function setQuestionnaireAnswersObject(object) {
  ...
  $scope.answers = {};
  for(key in answers) {
    $scope.answers[key] = answers[key].Answer;
  }
  console.log($scope.answers);
}
...
$scope.clicked1 = function (option, i, otherAns) {
  ...
  Questionnaires.setQuestionnaireAnswers($scope.answers[$scope.index-1], $scope.index-1, 0);
  ...
  if ((option == 'other') && ((otherAns == undefined) || (otherAns == ""))) {
    ...
    Questionnaires.setQuestionnaireAnswers(undefined, $scope.index-1, 0);
    $scope.numAnswered = $scope.numAnswered - 1;
  }
}
...
/////////////////////////
  ...
  $scope.clicked2 = function(ans, index) {
    ...
    Questionnaires.setQuestionnaireAnswers(ans, $scope.index-1, 0);
    console.log('ans = ' + ans);
  ...
  /////////////////////////
    $scope.answer3 = function (checkbox, index) {
      ...
      Questionnaires.setQuestionnaireAnswers(checkbox, $scope.index-1, 0);
    }
  ...
  /////////////////////////
    ...
    $scope.answer4 = function (answer) {
      ...
      Questionnaires.setQuestionnaireAnswers(answer, $scope.index-1, 0);
  ...
  if($scope.hasOwnProperty('questions')) $scope.answerToShow = new Array($scope.questions.length);
    ...
    $scope.submitAns = function () {
      ...
      Questionnaires.submitQuestionnaire(0);
    }
