...
function fireConfig () {
    ...
    var config = {
        ...
        // local (Yuan)
        //
        apiKey: "AIzaSyBFhzmXGi8lzTqGNe3udnsLWsfJh-YIPfQ",
        authDomain: "opalstaging-6ecfc.firebaseapp.com",
        databaseURL: "https://opalstaging-6ecfc.firebaseio.com",
        projectId: "opalstaging-6ecfc",
        storageBucket: "opalstaging-6ecfc.appspot.com",
        messagingSenderId: "1001742009752",
    };
