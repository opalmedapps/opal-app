...
class OpalEnv {
	 ...
	 * @param {string} env string value for the environment, normally one of ['local', 'dev', 'qa', 'staging', 'preprod', 'prod', etc.].
	 */
	 ...
	 * @param {string} env Environment from which to get the version, normally one of ['local', 'dev', 'qa', 'staging', 'preprod', 'prod', etc.].
	 */
