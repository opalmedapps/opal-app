...
class OpalEnv {
	...
	static updateWebVersion(env) {
        ...
        /* Write the version number to env/web-version.json, which is made accessible everywhere in the app using
         * the webpack ProvidePlugin (as WEB_VERSION). The values in this file are used as the app's web version number.
         */
        fs.writeFileSync("../../env/web-version.json", `{\n`
        + '    "_comment": "This file is automatically filled in when building the app, using information from config.xml; do not edit.",\n'
